...
type WorktreeHealth struct {
	...
	// UncommittedChanges is true when `git status --porcelain` reports any
	// tracked or untracked change in workDir. Always false when
	// WorktreeMissing (nothing to check).
